/**
 * This file was generated from WebXR3DObject.xml
...
export interface WebXR3DObjectContainerProps {
    name: string;
    class: string;
    style?: CSSProperties;
    tabIndex?: number;
...
export interface WebXR3DObjectPreviewProps {
    /**
    ...
    mxDragType: MxDragTypeEnum;
    mxScalingEnabled: string;
    mxRotationEnabled: string;
    mxOnDrag: {} | null;
    mxOnScale: {} | null;
    mxGizmoColor: string;
    mxGizmoSize: string;
