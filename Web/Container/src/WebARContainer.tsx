...
import { ArcRotateCamera, Color3, Color4, CubeTexture, Engine, HemisphericLight, Mesh, Scene, SceneLoader, Tools, Vector3, WebXRExperienceHelper, WebXRSessionManager } from "@babylonjs/core";
